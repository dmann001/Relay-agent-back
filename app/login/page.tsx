...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen bg-[#0A0A0B] text-[#FAFAF9] selection:bg-[#E8DCC4]/20 overflow-hidden">
      ...
      <div className={`absolute top-8 left-8 z-20 transition-all duration-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
        <Button
          asChild
          variant="ghost"
          className="text-[#8A8A8A] hover:text-[#FAFAF9] hover:bg-white/[0.03] rounded-xl border border-transparent hover:border-white/[0.06]"
        >
          <Link href="/">
      ...
      <div className="relative w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 h-full">
        ...
        <div className="flex flex-col justify-center px-8 sm:px-10 lg:px-12 py-8 relative overflow-hidden">
          <div className={`w-full max-w-md mx-auto space-y-6 transition-all duration-1000 delay-150 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="relative p-[1px] rounded-2xl bg-gradient-to-b from-white/[0.08] to-white/[0.02]">
              <div
              ...
              >
                {/* Tab Switcher */}
                <div className="flex p-1 rounded-xl bg-white/[0.03] border border-white/[0.04] mb-5">
                  <button
                    onClick={() => setActiveTab("signin")}
                    className={`flex-1 py-2.5 px-4 rounded-lg text-sm font-medium transition-all duration-200 ${activeTab === "signin"
                      ? "bg-white/[0.08] text-[#FAFAF9] border border-white/[0.08]"
